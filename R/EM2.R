...
EM2 <- function(y,x,p=0.5,dist = "normal",nu="",gama="",precision = 0.000001,envelope=FALSE){
  ...
  if(envelope==TRUE && dist == "normal"){
    ...
    plot(xq2,d2s,xlab = expression(paste(HN(0.5), " quantiles")), 
         ylim = fy,ylab="Sample values",pch=20,cex=0.8,type="n",
         main = paste("Normal"))
  ...
  if(envelope==TRUE && dist == "t"){
    ...
    fy <- range(d2s,d21,d22)
    plot(xq2,d2s,xlab = expression(paste(HT(0.5,nu), " quantiles")), 
         ylim = fy,ylab="Sample values",pch=20,cex=0.8,type="n",
         main = paste("Student-t"))
  ...
  if(envelope==TRUE && dist == "laplace"){
    ...
    fy <- range(d2s,d21,d22)
    plot(xq2,d2s,xlab = expression(paste(Exp(0.5)," quantiles")),
         ylim = fy,ylab="Sample values",pch=20,cex=0.8,type="n",
         main = paste("Laplace"))
  ...
  if(envelope==TRUE && dist == "slash"){
    ...
    fy <- range(d2s,d21,d22)
    plot(xq2,d2s,xlab = expression(paste(HSl(0.5,nu), " quantiles")), 
         ylim = fy,ylab="Sample values",pch=20,cex=0.8,type="n",
         main = paste("Slash"))
  ...
  if(envelope==TRUE && dist == "cont"){
    ...
    fy <- range(d2s,d21,d22)
    plot(xq2,d2s,xlab = expression(paste(HCN(0.5,nu,gamma)," quantiles")), 
         ylim = fy,ylab="Sample values",pch=20,cex=0.8,type="n",
         main = paste("Cont. Normal"))
